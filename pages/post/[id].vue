	...
	>
		<div class="lg:w-[calc(100%-540px)] h-full relative">
			...
			<video
				...
				src="/carpenter-tool-handmade.mp4"
			/>
		...
		>
			...
			<div class="flex items-center justify-between px-8">
				<div class="flex items-center">
					...
					<div class="ml-3 pt-0.5">
						...
						<div class="text-[17px] -mt-5 font-light">
							User Name
							<span class="relative -top-[2px] text-[30px] pr-0.5"
								>.</span
							>
			...
			<div class="px-8 mt-4 text-sm">This is a post test</div>
					...
					<div class="flex items-center relative w-full">
						...
						<div class="ml-14 pt-0.5 w-full">
							...
							<div class="text-[15px] font-light">
								...
								adipiscing elit, sed do e ullamcorper nulla
								pariatur et just e temp nulla pariatur et just e
								temp nulla pariatur et just e temp nulla par
								successive nulla par successive nulla par
								successive nulla par successive nulla par
								successive nulla par successive nulla par
								successive nulla par successive nulla par
								successive nulla par
							</div>
						</div>
					</div>
				</div>

		...
		>
			...
			<div class="mt-8 md:flex gap-6">
				...
				>
					...
					<div class="mt-2 text-gray-400 text-sm">Less than 2 GB</div>
					<div
						class="px-2 py-1.5 mt-9 text-white text-[15px] w-[80%] bg-[#F02C56] rounded-sm"
					>
						Select file
					</div>
					<input
				...
				>
					...
					>
						<div class="flex items-center truncate">
							...
							/>
							<div
								class="text-[11px] pl-1 truncate text-ellipsis"
							>
								{{ fileData.name }}
							</div>
						</div>
				...
				<div class="mt-4 mb-6">
					<div class="flex bg-[#F8F8F8] py-4 px-6">
						...
						<div>
							...
							<div
								class="text-semibold text-[13px] text-gray-400"
							>
								You can quickly divide videos into multiple
								parts, remove abundant parts and turn landscape

<template>
	...
	>
		...
		>
			...
			>
				<div class="text-[22px] font-semibold">Edit profile</div>
				<button
					@click="
						($event) => ($generalStore.isEditProfileOpen = false)
					"
				>
						...
						<div class="flex items-center justify-center sm:-mt-6">
							<label for="image" class="relative cursor-pointer">
								<img
									class="rounded-full"
									width="95"
									src="https://picsum.photos/id/8/300/326"
								/>
								<div
			...
			>
				...
				>
					<button
						@click="
							($event) => ($generalStore.isEditProfileOpe = false)
						"
